...
import 'package:survey_app_flutter/presentation/admin/surveys_list_page.dart/survey_builder/sections/questions_widgets/question_preview_badge.dart';
...
class QuestionPreview extends StatelessWidget {
  ...
  final QuestionPreviewData question;

  String _maxLimitText() {
    if (question.type == QuestionType.multipleChoice) {
      return AppStrings.questionPreviewMaxSelections(question.maxOptions ?? 0);
    }
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          // TODO: add options to the preview
        ],
      ),
    );
  }
